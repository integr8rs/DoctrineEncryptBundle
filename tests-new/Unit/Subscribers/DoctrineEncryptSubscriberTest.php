...
namespace DoctrineEncryptBundle\DoctrineEncryptBundle\Tests\Unit\Subscribers;
...
use DoctrineEncryptBundle\DoctrineEncryptBundle\Tests\Unit\Subscribers\fixtures\ExtendedUser;
use DoctrineEncryptBundle\DoctrineEncryptBundle\Tests\Unit\Subscribers\fixtures\User;
use DoctrineEncryptBundle\DoctrineEncryptBundle\Tests\Unit\Subscribers\fixtures\WithUser;
...
class DoctrineEncryptSubscriberTest extends TestCase
{
    ...
    private function triggerProcessFields(object $entity, bool $encrypt): void
    {
        \Closure::bind(
            function($entity, $entityManager, $encrypt) {
                $this->processFields($entity, $entityManager, $encrypt);
            },
            $this->subscriber,
            DoctrineEncryptSubscriber::class
        )($entity, $this->em, $encrypt);
    }
